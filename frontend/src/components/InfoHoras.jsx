        ...
        <div className="col-span-2 bg-gray-100 p-4 rounded">
            <div className="grid grid-cols-4 gap-4 text-center">
                ...
                <div className="bg-white p-2 rounded shadow-sm">
                    ...
                    <p className={`text-2xl font-bold ${getColorTotalHoras()}`}>
                        {horasTotales}
                    </p>
                </div>
                <div className="bg-white p-2 rounded shadow-sm">
                    ...
                    <p className="text-lg font-bold text-purple-600">
                        {programaSeleccionado?.horas || 0} / {(programaSeleccionado?.horas || 0) + (horasPorDia || 0)}
                    </p>
            ...
            {programaSeleccionado && (
                <div className="mt-3 text-center">
                    <p className="text-sm text-gray-700 font-medium">
                        Programa: <span className="text-blue-800 font-bold">{programaSeleccionado.nombrePrograma}</span>
                    </p>
                </div>
            )}

            {mensajeHorario && (
                <div className={`mt-3 p-2 rounded text-center font-bold ${getColorMensaje()}`}>
                    {mensajeHorario}
                </div>
            )}
        </div>
