                            ...
                            <div className="flex items-center gap-3">
                                <div className="text-right">
                                    ...
                                    <div className="flex items-center gap-1.5 justify-end">
                                        ...
                                        <span className="text-xs font-medium text-green-600">Curricular</span>
                ...
                <div className="border-t border-slate-100 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center gap-6 h-12 text-sm">
                            ...
                            {params.id ?
                                <NavLink
                                    to={`/curricular/crear-programa/${params.id}`}
                                    className={({ isActive }) =>
                                        `h-full flex items-center px-1 border-b-2 transition-colors
                                        ${isActive
                                            ? "text-green-600 border-green-600 font-medium"
...
export default HeaderCurricular
