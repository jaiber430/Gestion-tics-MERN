...
// Componente de card con header verde institucional
const Card = ({ titulo, icono, children }) => (
                ...
                <div className="mb-8 flex items-start justify-between">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            <div className="w-10 h-10 bg-gradient-to-br from-green-600 to-emerald-500 rounded-xl flex items-center justify-center shadow">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    Tipo: <span className="font-semibold text-green-700">{tipoSolicitud}</span>
                                    {s?.tipoOferta && <span className="ml-2 px-2 py-0.5 bg-slate-100 text-slate-600 text-xs rounded-full">{s.tipoOferta}</span>}
                                    {console.log('tipoEmpresa:', JSON.stringify(s?.empresaSolicitante?.tipoEmpresa, null, 2))}
                                    {console.log('programaEspecial:', JSON.stringify(s?.programaEspecial, null, 2))}
                                </p>
                            </div>
                        </div>
                    </div>
